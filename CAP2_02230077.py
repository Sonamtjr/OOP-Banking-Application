...
class Account:
    def _init_(self, accountnumber, password, type_of_account, remaining_balance=0):
...
class BusinessAccount(Account):
    def _init_(self, accountnumber, password, remaining_balance=0, business_name=""):
        super()._init_(accountnumber, password, "Business", remaining_balance)
...
class PersonalAccount(Account):
    def _init_(self, accountnumber, password, remaining_balance=0, owner_name=""):
        super()._init_(accountnumber, password, "Personal", remaining_balance)
